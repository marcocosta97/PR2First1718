 ...
 * quanto gli elementi chiave sono mantenuti ordinati rispetto al loro 
 * ordinamento predefinito.
 * 
 * @author mc
 */
public class DataCounterTreeImpl<E extends Comparable<E>> implements DataCounter<E> {
    /**
     ...
     *           table.get(i) &gt; 0)</tt>
     */   
    private final TreeMap<E, Integer> table;
    
    public DataCounterTreeImpl() {
        table = new TreeMap<>();
    }
     ...
     * EFFECTS: aggiunge l'elemento data all'oggetto sse <tt>!(table.contains(data))</tt>
     ...
     *          presente, altrimenti richiama il metodo add(data).
     ...
     */
    private static class DataCounterGen<E> implements Iterator<E> {
         ...
         *          struttura di tipo <tt>ArrayList</tt>.
         * 
